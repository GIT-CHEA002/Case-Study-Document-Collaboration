...
| ID | Requirement | Reference Text |
| :--- | :--- | :--- |
| **UR-NF01** | **Product Requirement:** The mental health care system shall be available to all clinics during normal working hours, Monday to Friday from 08:30 to 17:30. Downtime during normal working hours shall not exceed five seconds in any one day. | [S3] “The mental health care system shall be available to all clinics during normal working hours (Mon–Fri, 0830–17.30). Downtime within normal working hours shall not exceed five seconds in any one day.” |
| **UR-NF02** | **Organizational Requirement:** Users of the mental health care system shall authenticate themselves using their health authority identity card. | [S3] “Users of the mental health care system shall authenticate themselves using their health authority identity card.” |
...
| **UR-NF04** | **Infrastructure Requirement:** The mental health care system shall run on Linux server hardware available in the health authority's data centre. | [S4] “The mental health care system shall run on hardware (Linux servers) that is available in the authority's data centre.” |
...
* **[S4]** GitHub, opendesigncasestudies/mental health care-IanSommerville — case study text retrieved from Ian Sommerville's *Software Engineering*, 10th Edition — https://github.com/opendesigncasestudies/mental health care-IanSommerville (original: Sommerville, I. (2016) *Software Engineering*, 10th Edition, Pearson Education Limited, Boston)
